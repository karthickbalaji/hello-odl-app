 ...
 */
package org.opendaylight.demo.cli.commands;
...
public class SampleNetworkCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(SampleNetworkCliTestCommand.class);
    protected final SampleNetworkCliCommands service;

    public SampleNetworkCliTestCommand(final SampleNetworkCliCommands service) {
